...
class AgentServiceClient:
    def __init__(self, base_url, *, pool=None, compressor=None, json=False, **opts):
        ...
        self._deploy_branch = connect.Client(
            pool=pool,
            url=f"{base_url}/{AgentServiceName}/DeployBranch",
            response_type=cloud_dot_agent_dot_v1_dot_agent__pb2.DeployBranchAgentResponse,
            compressor=compressor,
            json=json,
            **opts
        )
        self._list_branch = connect.Client(
            pool=pool,
            url=f"{base_url}/{AgentServiceName}/ListBranch",
            response_type=cloud_dot_agent_dot_v1_dot_agent__pb2.ListBranchAgentResponse,
            compressor=compressor,
            json=json,
            **opts
        )
    ...
    def deploy_branch(self, req, **opts):
        return self._deploy_branch.call_unary(req, **opts)

    def list_branch(self, req, **opts):
        return self._list_branch.call_unary(req, **opts)
