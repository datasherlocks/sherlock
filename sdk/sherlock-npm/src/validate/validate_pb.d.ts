...
import type { BinaryReadOptions, Duration, Extension, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage, Timestamp } from "@bufbuild/protobuf";
import { FieldOptions, Message, MessageOptions, OneofOptions, proto2 } from "@bufbuild/protobuf";
 ...
 */
export declare const disabled: Extension<MessageOptions, boolean>;
 ...
 */
export declare const ignored: Extension<MessageOptions, boolean>;
 ...
 */
export declare const required: Extension<OneofOptions, boolean>;
 ...
 */
export declare const rules: Extension<FieldOptions, FieldRules>;
