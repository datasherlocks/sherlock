 ...
 */
export const disabled = proto2.makeExtension(
  "validate.disabled", 
  MessageOptions, 
 ...
 */
export const ignored = proto2.makeExtension(
  "validate.ignored", 
  MessageOptions, 
 ...
 */
export const required = proto2.makeExtension(
  "validate.required", 
  OneofOptions, 
  { no: 1071, kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
);
 ...
 */
export const rules = proto2.makeExtension(
  "validate.rules", 
  FieldOptions, 
